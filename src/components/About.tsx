        ...
        <div className="grid grid-cols-1 md:grid-cols-[400px_1fr] gap-12 items-start">
          ...
          <div className="space-y-6 text-secondary-foreground/90 leading-relaxed text-base md:text-lg">
            <p>
              ...
              I am currently enrolled at <span className="font-extrabold text-orange-400">EPITECH</span> in France, pursing a Master's Degree in Computer Science. Along the way, I’ve developed a strong focus on <span className="font-extrabold text-orange-400">C++ and low-level programming</span>, with additional experience in <span className="font-extrabold text-orange-400">C# for Unity</span>. What excites me most is working close to the engine: building robust game systems, experimenting with rendering techniques, and designing foundations that scale well in real-world scenarios.
              <br /><br />
